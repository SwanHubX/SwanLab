...
- 2025.12.01: 🕰 При наведении курсора на мышь нажатие Shift включает подробный режим, позволяющий отображать время точки журнала; 📊 Группировка графиков теперь поддерживает отображение диапазона MIN/MAX; Исправления: исправлена ошибка на панели «Список», возникающая при многократном скрытии, а также другие проблемы, сообщённые пользователями;
