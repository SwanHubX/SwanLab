...
- 2025.12.01: 2025.12.01: 🕰 При наведении курсора на мышь нажатие Shift включает подробный режим, поддерживающий отображение времени точки лога; 📊 Группировка графиков поддерживает отображение диапазонов MIN/MAX; исправлена ошибка в панели «Список», вызванная многократным скрытием, а также другие проблемы, о которых сообщали пользователи;
