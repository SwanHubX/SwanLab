...
- 2026.05.18: 📊 Добавлена функция **копирования графиков**; логи теперь поддерживают **глобальную фильтрацию**, чтобы можно было быстро находить нужные фрагменты логов; в поиске по графикам появилась **история запросов**; в деталях графиков теперь отображается **относительное время**;
