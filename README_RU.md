...
- 2024.12.22: Мы совместили SwanLab с [LLaMA Factory](https://github.com/hiyouga/LLaMA-Factory), теперь вы можете использовать SwanLab в LLaMA Factory для **отслеживания и визуализации экспериментов с большими моделями**,[Руководство по использованию](https://github.com/hiyouga/LLaMA-Factory?tab=readme-ov-file#use-swanlab-logger).

- 2024.12.15: **Функция мониторинга оборудования (0.4.0)** запущена, поддерживающая запись и мониторинг системных уровней информации для CPU, NPU (Ascend) и GPU (Nvidia).

- 2024.12.06: Добавлена интеграция с [LightGBM](https://docs.swanlab.cn/guide_cloud/integration/integration-lightgbm.html) и [XGBoost](https://docs.swanlab.cn/guide_cloud/integration/integration-xgboost.html); увеличена длина строки для записи журналов.

- 2024.11.26: В разделе "Окружение" - "Оборудование" добавлена поддержка распознавания **Huawei Ascend NPU** и **Kunpeng CPU**; в разделе "Провайдер облака" добавлена поддержка распознавания **QingCloud GritStone**.

- 2024.11.24: Запущена **новая версия интерфейса** с переработанным дизайном, оптимизированы многие взаимодействия и добавлена поддержка темной темы.

- 2024.11.11: Запущен [VSCode](https://marketplace.visualstudio.com/items?itemName=SwanLab.swanlab&ssr=false#overview) плагин; добавлена интеграция с [Keras](https://docs.swanlab.cn/guide_cloud/integration/integration-keras.html); добавлен метод `run.public`, позволяющий получать информацию о проекте, эксперименте и ссылке на эксперимент,[#732](https://github.com/swanhubx/swanlab/issues/732).
