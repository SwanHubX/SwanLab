...
- 2025.01.17: Добавлена функция `sync_wandb`, поддерживающая синхронизацию с отслеживанием экспериментов Weights & Biases; значительно улучшена производительность рендеринга логов.
