...
- 2025.12.15: 🎉 SwanLab**Kubernetes版** теперь доступен! [🔗 Документация](https://docs.swanlab.cn/en/guide_cloud/self_host/kubernetes-deploy.html); [NVIDIA NeMo RL](https://docs.swanlab.cn/en/guide_cloud/integration/integration-nvidia-nemo-rl.html) фреймворк теперь интегрирован с SwanLab;
