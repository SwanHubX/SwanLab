...
// @author: ComPleHN
// @file: map3d.vue
// @time: 2025/5/28 12:35
// @description: 本文件是对于echarts的 3D地图 图表测试
"""
# ---------------------------------------------- Map3d - Map3d_with_lines3d ---------------------------------------------- 
...
swanlab.init(
    ...
    experiment_name="map3d",
    public=True,
)

swanlab.log(
    {
        "Map3d - Map3d_with_lines3d": c1,
        "Map3d - Map3d_with_scatter3d": c2,
        "Map3d - Map3d_with_bar3d": c3,
        "Map3d - Map3d_china_base": c4
    }
)
