...
- 2025.12.01: 🕰 マウス上にホバーした状態で Shift をクリックすると詳細モードが有効になり、ログポイントの時間を表示できます；📊 チャートのグループ化で **MIN/MAX 範囲エリアの表示**をサポート；「リスト」パネルで複数回の非表示によって発生したバグおよびユーザーからのフィードバック問題を修正しました；
