...
- 2025.02.09: 我們與 [veRL](https://github.com/verl-project/verl) 完成了聯合集成，現在你可以在 veRL 中使用 SwanLab 來**跟踪和可視化大模型強化學習實驗**，[使用指引](https://docs.swanlab.cn/en/guide_cloud/integration/integration-verl.html)。
