...
- 2025.12.01: 🕰 When hovering over the mouse, clicking Shift will activate Detailed Mode, allowing the display of the log point time; 📊 Chart grouping supports **MIN/MAX area range display**; fixed the bug caused by multiple hides in the "List" panel and issues reported by users;
