...
def init(
    ...
    private : bool, optional
        Whether the project is private, the default is False.
    ...
    if load:
        ...
        private = _load_data(load_data, "private", private)
    operator, c = _create_operator(mode, private)
...
def _create_operator(mode: str, private: bool) -> Tuple[SwanLabRunOperator, Optional[CloudRunCallback]]:
    """
    ...
    c = CloudRunCallback(private) if mode == SwanLabMode.CLOUD.value else LocalRunCallback()
