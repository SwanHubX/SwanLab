...
from .modules import DataType, PyEchartsTable, PyEchartsBase
from .run import (
    SwanLabRunState,
    SwanLabRun,
    register,
...
def log(
    data: Dict[str, Union[DataType, PyEchartsBase, PyEchartsTable, List[PyEchartsTable], List[PyEchartsBase]]],
    step: int = None,
