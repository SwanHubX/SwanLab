...
def check_expriment_name(name: str, exists_name: [str]) -> str:
    ...
    if name in exists_name:
        ...
        return check_expriment_name(new_name, exists_name)
    return name


# 示例调用
random_tree = generate_random_tree_name()
print("Randomly generated tree name:", random_tree)
