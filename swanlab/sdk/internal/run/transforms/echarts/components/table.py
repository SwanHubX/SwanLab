...
@author: cunyue
@file: table.py
@time: 2026/4/29 18:37
@description: ECharts 表格
"""
...
class Table(PyechartsTable):
    ...
    def add(self, headers: Sequence, rows: Sequence, attributes: Optional[dict] = None, **kwargs):
        super().add(headers, rows, attributes, **kwargs)
    ...
    def get_table_format(self) -> dict:
        ...
        assert original_data is not None, "original_data is None when get_table_format"
