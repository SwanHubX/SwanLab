...
log_echarts = _make_run_cmd("log_echarts")
log_object3d = _make_run_cmd("log_object3d")
log_molecule = _make_run_cmd("log_molecule")
log_html = _make_run_cmd("log_html")
async_log = _make_run_cmd("async_log")
define_metric = _make_run_cmd("define_metric")
finish = _make_run_cmd("finish")
save = _make_run_cmd("save")
