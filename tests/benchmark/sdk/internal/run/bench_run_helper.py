...
def test_flatten_wide(benchmark, wide_dict):
    ...
    benchmark(F.flatten_dict, wide_dict)


def test_flatten_deep(benchmark, deep_dict):
    """深层嵌套字典展开（depth=50）"""
    benchmark(F.flatten_dict, deep_dict)
