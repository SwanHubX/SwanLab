...
.main-container {
  @apply w-screen flex h-[calc(100vh-56px)] overflow-auto;
}
...
// 遮罩
.sidebar-overlay {
  @apply absolute w-full h-full overflow-x-hidden z-50;
  background-color: var(--background-overlay);
  animation: fadeIn $duration ease;
}
// sidebar容器
.sidebar-container {
  @apply z-50 box-content h-full overflow-y-auto overflow-x-clip flex-shrink-0 md:static absolute;
  // 宽度变化
  transition: width $duration ease-in-out;
  // 将滚动条隐藏
  &::-webkit-scrollbar {
