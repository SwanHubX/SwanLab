...
<p align="center">SwanLab is a robust open-source machine-learning training management tool for researchers to track and record their experiment. By using SwanLab, researchers can accumulate training experience and discover new ideas.</p>
...
And there will be 1 **`swanlog`** folder in the root directory, which contains files automatically generated by SwanLab, recording a series of experimental data.
