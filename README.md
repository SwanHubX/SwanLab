...
- 2025.07.29：🚀侧边栏支持实验筛选、排序；📊表格视图上线列控制面板，能够方便地实现列的隐藏与显示；🔐支持管理多个API Key，让你的数据更安全；swanlab sync已支持训练崩溃的日志文件；PR曲线、ROC曲线、混淆矩阵上线，[文档](https://docs.swanlab.cn/api/py-pr_curve.html)；
